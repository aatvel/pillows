...
VoxelLandscape.prototype.update = function () {
  ...
  for (var i = 0; i < this.boxes.length; i++) {
    var b = this.boxes[i]
    b.position.set(b.xi * sx + b.nx * sx * 0.5, b.yi * sy + b.ny * sy * 0.5, b.zi * sz + b.nz * sz * 0.5)
